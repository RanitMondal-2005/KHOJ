...
In settings.py, these 2 backends are registered in AUTHENTICATION_BACKENDS in sequence:
...
3. If a match is found and the password hashes match, that user is returned and login succeeds.
"""
